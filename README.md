...
We assembled six chromosome-scale Salicornia genomes and analyzed a global resequencing panel of 318 accessions using comprehensive population genomic analyses, including phylogenetic reconstruction, population structure, nucleotide diversity (π), Tajima's D, genetic differentiation (FST), read-depth–based genome coverage analysis, and ploidy determination. Our results reveal taxonomic inconsistencies and extensive genetic diversity, establishing a genomic foundation for breeding and the neo-domestication of Salicornia for saline agriculture.
...
Contains scripts and input files required to generate genome coverage plots and perform read-depth–based genome coverage analyses.
...
### Variant-Calling
Contains scripts and parameter settings used for read alignment, variant callinghttps://docs.github.com/github/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax, variant filtering, and generation of the final SNP datasets.
