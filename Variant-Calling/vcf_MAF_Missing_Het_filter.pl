...
unless(defined $ARGV[0] and defined $ARGV[1] and defined $ARGV[2] and defined $ARGV[3]){
    say "USAGE:\n/ibex/scratch/adhikal/Monococcum/TA299_annotated_obtained_Dryad/vcf_MAF_Missing_Het_filter.pl file.vcf MAF missing% het%";
    say "\n1. VCF file";
    ...
    say "\nNo filtering:\n /ibex/scratch/adhikal/Monococcum/TA299_annotated_obtained_Dryad/vcf_MAF_Missing_Het_filter.pl file.vcf MAF(0 no filter) missing(100 no filter) het(100 no filter)";
